...
{
       0,    40,    40,    51,    56,    59,    70,    73,    78,    81,
      82,    85,    97,   101,   105,   119,   120,   121,   128,   137,
     140,   141,   142,   143,   146,   147,   151,   171,   177,   184,
     185,   186,   187,   188,   189,   192,   197,   200,   211,   212,
     215,   220,   223,   233,   237,   240,   252,   256,   260,   263,
     270,   271,   272,   273,   274,   275,   276,   279,   288,   297,
     309,   323,   327,   332,   333,   336,   345,   355
};
#endif
...
static const char *const yytname[] =
{
  ...
  "close_par", "open_par", "fuopen", "t_ret", "fuclose", "end", "is_fun",
  "int_var", "string_var", "var_name", "$accept", "PROGRAM", "DEF_VARS",
  "DEF_VAR", "GLOB_VARS", "VARS", "VAR", "DECLARE", "ASSIGN", "REASSIGN",
  "EXP", "OP", "TYPE", "EVALUATE", "COMP", "DEF_FUNCS", "DEF_FUNC",
  "ALL_ARGS", "ARGS", "ARG", "FUNCS", "FUNC", "BODY", "LINE", "CMD", "INC",
  "DEC", "PRINT", "SCAN", "RET", "BLOCK", "IFBLOCK", "WHILEBLOCK",
...
{
      -6,   -29,    48,    14,   -19,    57,   -75,   -75,   -75,    57,
      53,   -75,    41,   -75,   -75,    39,    -6,    57,   -75,   -75,
     -75,    65,   -75,    65,    51,    61,    63,    14,    57,   -75,
      34,    57,    57,    57,    57,     9,    62,    71,    61,    53,
     -75,   -75,    65,   -75,    73,    73,   -75,   -75,    69,     9,
       9,   -75,   -75,   -75,     9,    72,    74,    67,    77,   -75,
      75,     9,     9,   -75,   -75,     9,    78,    79,   -75,    70,
      80,    -1,    -1,    82,    83,    57,    57,    57,    21,   -75,
     -75,    76,    -1,    81,   -75,   -75,   -75,   -75,   -75,    -1,
     -75,   -75,    84,    85,    57,    60,    26,    42,    65,   -75,
     -75,   -75,   -75,   -75,   -75,   -75,    87,    49,   -75,   -75,
     -75,   -75,   -75,   -75,    57,    57,    57,    -1,    -1,   -75,
     -75,    65,    94,   -75,   102,   101,   -75,   -75
};
...
{
       4,     0,     0,     8,     0,     0,     1,    24,    25,     0,
      36,     6,     0,     9,    10,     0,     4,     0,    16,    15,
      17,     5,    19,    14,     0,    44,     0,     8,    13,     3,
       0,     0,     0,     0,     0,     0,     0,     0,    44,    36,
       7,    11,    12,    18,    20,    21,    22,    23,     0,     0,
       0,     2,    43,    35,    39,     0,     0,     0,     0,    38,
      41,    39,    39,    42,    37,     0,     0,     0,    40,     0,
       0,    48,    48,     0,     0,     0,     0,    62,     0,    51,
      50,     0,    48,     0,    52,    53,    54,    55,    56,    48,
      63,    64,     0,     0,     0,     0,     0,     0,    61,    57,
      58,    45,    46,    49,    47,    67,     0,     0,    29,    30,
      34,    32,    33,    31,     0,     0,     0,    48,    48,    60,
      59,    26,    27,    28,     0,     0,    66,    65
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -75,   -75,   103,   -75,   -75,    93,   -75,    22,   -75,    40,
      -5,   -75,   -30,   -74,   -75,    86,   -75,    29,    56,   -75,
      88,   -75,   -71,   -75,   -75,   -75,   -75,   -75,   -75,   -75,
     -75,   -75,   -75,   -75
};
...
{
      -1,     2,     3,     4,    10,    11,    12,    79,    41,    80,
      95,    22,    15,    96,   114,    25,    26,    58,    59,    60,
      37,    38,    81,    82,    83,    84,    85,    86,    87,    88,
      89,    90,    91,    51
};
...
{
      21,    92,    97,     1,    23,    48,     7,     8,     5,    73,
      74,   102,    30,    75,    16,    76,     7,     8,   104,    55,
      56,     7,     8,    42,    57,    13,    44,    45,    46,    47,
      77,    57,    57,    99,   100,    57,    78,    31,    32,    33,
      34,   122,   123,    14,   115,   116,   124,   125,     6,    13,
      17,     9,    31,    32,    33,    34,    18,    19,    20,   117,
     115,   116,    43,    31,    32,    33,    34,    14,    31,    32,
      33,    34,    98,    23,    27,   118,    28,   120,    33,    34,
     108,   109,   110,   111,   112,   113,    17,    24,    35,   107,
      66,    67,    18,    19,    20,    36,    39,    50,    54,    49,
      71,    61,    65,    62,    63,    64,    69,    70,   101,   121,
      72,    93,    94,   116,   103,   119,   105,   126,   127,    29,
      40,    68,   106,     0,     0,    53,    52
};

static const yytype_int8 yycheck[] =
{
       5,    72,    76,     9,     9,    35,     7,     8,    37,    10,
      11,    82,    17,    14,    33,    16,     7,     8,    89,    49,
      50,     7,     8,    28,    54,     3,    31,    32,    33,    34,
      31,    61,    62,    12,    13,    65,    37,     3,     4,     5,
       6,   115,   116,     3,    18,    19,   117,   118,     0,    27,
      29,    37,     3,     4,     5,     6,    35,    36,    37,    33,
      18,    19,    28,     3,     4,     5,     6,    27,     3,     4,
       5,     6,    77,    78,    33,    33,    37,    28,     5,     6,
      20,    21,    22,    23,    24,    25,    29,    34,    37,    94,
      61,    62,    35,    36,    37,    34,    33,    26,    29,    37,
      30,    29,    27,    29,    37,    28,    28,    28,    32,   114,
      30,    29,    29,    19,    33,    28,    32,    15,    17,    16,
      27,    65,    37,    -1,    -1,    39,    38
};
...
{
       0,     9,    39,    40,    41,    37,     0,     7,     8,    37,
      42,    43,    44,    45,    47,    50,    33,    29,    35,    36,
      37,    48,    49,    48,    34,    53,    54,    33,    37,    40,
      48,     3,     4,     5,     6,    37,    34,    58,    59,    33,
      43,    46,    48,    28,    48,    48,    48,    48,    50,    37,
      26,    71,    58,    53,    29,    50,    50,    50,    55,    56,
      57,    29,    29,    37,    28,    27,    55,    55,    56,    28,
      28,    30,    30,    10,    11,    14,    16,    31,    37,    45,
      47,    60,    61,    62,    63,    64,    65,    66,    67,    68,
      69,    70,    60,    29,    29,    48,    51,    51,    48,    12,
      13,    32,    60,    33,    60,    32,    37,    48,    20,    21,
      22,    23,    24,    25,    52,    18,    19,    33,    33,    28,
      28,    48,    51,    51,    60,    60,    15,    17
};
